  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{background:"black"}}>
        <Toolbar sx={{marginRight:"100px"}}>
          
          <Typography
            variant="h6"
            noWrap
            component="div"
            sx={{ display: { xs: 'none', sm: 'block' ,color:"#ed8907",marginLeft:"10%" , fontWeight:"bold",fontSize:"20px"} }}
          >
            Dhriti  &nbsp;Singh
          </Typography>
          ...
          <IconButton
            ...
            >
              <HashLink smooth to="/#home" style={{textDecoration :"none"}} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave}>
      ...
      color: '#ed8907', // Change color to red on hover
              ...
              <IconButton
                ...
                >
                  <HashLink smooth to="/#skills" style={{textDecoration :"none"}}   >
                  {/* <div style={{overflowY: 'scroll'}}  onClick={scrollToPosition} > */}
